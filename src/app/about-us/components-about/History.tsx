...
function History() {
    return (
        <div className='w-[904px]'>
            <div>
                <img src="/about-us/1.svg" alt="img" />
            </div>
            ...
            <div className='mt-3 bg-white py-6 px-8'>
                ...
                <div className='mt-4 text-[#424242] text-[18px] font-xmedium '>
                    <p>
                        وب‌سایت گردشگری درنا در سال ۱۴۰۲ با هدف ارتقای دسترسی کاربران به خدمات گردشگری و اطلاعات سفر راه‌اندازی شد. این پروژه توسط تیمی از متخصصان طراحی، توسعه و بازاریابی، بر پایه شناخت دقیق از نیازهای مسافران ایرانی و فناوری‌های روز دنیا، به وجود آمد. <br />
                ...
                <div className='mt-5'>
                    ...
                    <div>
                        <ul className='list-disc mt-3 text-[#424242] text-[18px] font-xmedium pr-4' >
                            <li>امکان مقایسه اسان تور ها</li>
