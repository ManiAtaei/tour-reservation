...
function BestComent() {
    ...
    const personsID = [
        ...
        { id: 2, name: "کاوه راد", score: 4.5, description: "درنا یک خاطره فوق العاده برای شما میسازه تجربه فوق العادی با خرید از درنا داشتم. باز هم تور رزرو خواهم کرد.", icon: "/icon-profile/1.png" },

        { id: 3, name: "کاوه راد", score: 4.5, description: "درنا یک خاطره فوق العاده برای شما میسازه تجربه فوق العادی با خرید از درنا داشتم. باز هم تور رزرو خواهم کرد.", icon: "/icon-profile/1.png" },

        { id: 4, name: "کاوه راد", score: 4.5, description: "درنا یک خاطره فوق العاده برای شما میسازه تجربه فوق العادی با خرید از درنا داشتم. باز هم تور رزرو خواهم کرد.", icon: "/icon-profile/1.png" },
